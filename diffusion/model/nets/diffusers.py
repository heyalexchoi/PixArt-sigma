...
def convert_net_to_diffusers(
        ...
        dump_path=None, # output save path. None to return transformer / pipeline
        ):
    interpolation_scale = interpolation_scale_alpha if version == "alpha" else interpolation_scale_sigma
    ...
    if micro_condition:
        assert version == 'alpha' and image_size // 8 == 128, "Only use for PixArt-Alpha 1024MS model"
        # Resolution.
    ...
    transformer = Transformer2DModel(
        ...
        interpolation_scale=interpolation_scale[image_size],
    ...
    if only_transformer:
        ...
        if version == "alpha":
            ...
            raise ValueError(f"{version} is NOT defined. Only alpha or sigma is available")
